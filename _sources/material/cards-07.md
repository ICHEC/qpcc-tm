...
# 7: Guest Lecture: Building a Quantum Computer
...
display_flashcards('./cards_07.json', front_colors=["beige"], back_colors=["cyan"], text_colors=["black"])
```
